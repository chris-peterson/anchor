...
closes the loop that `/anchor:create-review-request` opens: create-review-request routes
...
**Confirm local state matches the CR head** (same check as create-review-request):
