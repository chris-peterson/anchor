...
**Opening a CR is the exception — route it through `/anchor:create-review`,
...
checklist left intact, and no Review guide; `create-review` sets the draft
...
`create-review` rather than improvising the `create` inline. Editing or
