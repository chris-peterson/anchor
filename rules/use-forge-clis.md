...
**Opening a CR is the exception — route it through `/anchor:prepare-review`,
...
checklist left intact, and no Review guide; `prepare-review` sets the draft
...
`prepare-review` rather than improvising the `create` inline. Editing or
