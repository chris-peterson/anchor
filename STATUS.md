...
**Coverage:** 211 Covered, 0 Partial, 0 Missing/Contradicts
...
STATUS.md updated: +2 IDs (TARGET-10 and DIFF-21, both Covered), 209 → 211;
plugin version 1.5.0 → 1.6.0. Both came from a review that ran against the
working-directory repo because `--repo` trailed the mode flag.
